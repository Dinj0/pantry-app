...
"[project]/app/api/namirnice/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(namirnice);
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Greška pri dohvaćanju namirnica'
        }, {
            status: 500
        });
    }
...
async function POST(request) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(namirnica);
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Greška pri dodavanju namirnice'
        }, {
            status: 500
        });
    }
...
async function PATCH(request) {
    try {
        ...
        if (updateData.trenutnaKolicina === 0) {
            const namirnica = await prisma.namirnica.findUnique({
                where: {
                    id
                }
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__03nitp8._.js.map